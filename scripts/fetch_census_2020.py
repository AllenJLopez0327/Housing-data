"""
fetch_census_2020.py

Pulls 2020 Census housing unit counts for every census block
in all 58 California counties and saves the result to data/census_2020.csv.

Run from the repo root:
    python scripts/fetch_census_2020.py
...
OUTPUT    = Path('data/census_2020.csv')
